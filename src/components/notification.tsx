...
import { useNotification, type NotificationHandle } from '../hooks/useNotification';

/**
 * Simple notification component with imperative API
 */
export const Notification = forwardRef<NotificationHandle, {}>(
  function Notification(_, ref) {
