import { animated, type MoyuNodeAttributes, useTransition } from '@momoyu-ink/kit';
...
export function Dialog(props: DialogProps) {
  ...
  return transitions((style, _) => (
    <container x={1920 / 2} y={1080 / 2} interactive={show}>
      <sprite label="对话框遮罩" src="ui/mask.png" pivot={[0.5, 0.5]} anchor={[0.5, 0.5]} opacity={show ? 1 : 0} />
